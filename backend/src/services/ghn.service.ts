import { CreateGhnOrderPayload } from "#types/ghn.type";
...
const unwrapGhnData = (response: any) => {
...
export const getGhnDistrictsByProvinceService = async(provinceId: number) => {
...
export const getGhnWardsByDistrictService = async(districtId: number) => {
...
export const createGhnOrderService = async(payload: CreateGhnOrderPayload) => {
