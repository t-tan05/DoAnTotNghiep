...
async function emitGhnOrderUpdated(order: any) {
    try {
        const socketPayload = {
...
export const handleGhnOrderStatusWebhookService = async(payload: any) => {
...
async function handleDeliveredOrder(order: any, payload: any, ghnStatus: string) {
