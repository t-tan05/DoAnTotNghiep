...
import {
    getGhnDistrictsByProvinceService,
    getGhnProvincesService,
    getGhnWardsByDistrictService,
} from "#services/ghn.service";

export const getGhnProvincesController = CatchAsync(async(_req: Request, res: Response) => {
...
export const getGhnWardsController = CatchAsync(async(req: Request, res: Response) => {
