...
export const updateProductVariantService = async (variantId, data) => {
    ...
    const updProductVariant = await updateProductVariant(variantId, productVariantData, data?.attributeValueIds !== undefined, variantAttributeValueData, data?.specs !== undefined, productVariantSpecData);
