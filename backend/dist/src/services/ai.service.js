...
function buildProductContext(suggestions) {
...
export async function chatWithAiService(payload, owner) {
    ...
    try {
        ...
        await createAiProductSuggestions(suggestions.map((item, index) => ({
...
async function buildConversationHistoryResponse(conversation) {
...
export async function getLatestAiConversationService(owner) {
