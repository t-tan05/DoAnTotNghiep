...
export const findWishlistByUserAndVariant = async (userId, variantId) => {
...
export const findWishlistsByUserAndVariants = async (userId, variantIds) => {
...
export const deleteWishlistByUserAndVariant = async (userId, variantId) => {
...
export const getWishlistsByUserId = async (userId, page, limit) => {
...
export const findVariantByIdForWishlist = async (variantId) => {
